...
user_one = User.new(email: 'big_dummy@yolo.me', admin: true)
...
coordinate_two = Coordinate.new(street: 'Rue du Parlement', zip_code: 5000, city: 'Namur', country: 'Belgique')
contact_two = Contact.new(lastname: 'Dutronc', firstname: 'Anne', phone_number: '0498/11.22.33', email: 'anned@hotmail.com')
user_two = User.new(email: 'anned@hotmail.com', admin: false)
...
coordinate_three = Coordinate.new(street: 'Rue de l\'Atomium', zip_code: 1000, city: 'Bruxelles', country: 'Belgique')
contact_three = Contact.new(lastname: 'Lagaffe', firstname: 'Vincent', phone_number: '0471/54.21.87', email: 'vincentlagaffe@skynet.be')
user_three = User.new(email: 'vincentlagaffe@skynet.be', admin: false)
...
user_four = User.new(email: 'claire_chazal@tfi.fr', admin: true)
...
user_five = User.new(email: 'lucas_george@movies.us', admin: false)
