...
user_one = User.new(email: 'big_dummy@yolo.me', admin: true, skip_password_validation: true)
...
user_two = User.new(email: 'anned@hotmail.com', admin: false, skip_password_validation: true)
...
user_three = User.new(email: 'vincentlagaffe@skynet.be', admin: false, skip_password_validation: true)
...
user_four = User.new(email: 'claire_chazal@tfi.fr', admin: true, skip_password_validation: true)
